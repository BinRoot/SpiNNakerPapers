...
\IEEEPARstart{T}{he} human brain is fast and low in energy. blah blah blah. One property of the brain is it's plasticity (cite Lashley, or some Psyc studies). Our approach to neural networks is greatly influenced by this biological idea, and we want to enable networks to self-modify. 
...
Synaptogenesis is cool too. 
Here's why. 
Explain it's previous success from Levy's work.

\hfill

We're combining the two. And it's gonna be super userful.
