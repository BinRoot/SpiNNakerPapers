...
\caption{The letter U represented as a series of colored and blank pixels.\label{fig:U}}
\includegraphics[scale=0.3]{imgs/V.png}
\caption{The letter V represented as a series of colored and blank pixels.\label{fig:V}}
\end{figure}
...
\caption{The letter A is represented by the pixel sequence $000000001100010010010010011110010010010010010010$\label{fig:A}}
\end{figure}
o
...
\caption{Illustration of three input and one output chips on the SpiNNaker machine. The input chips consist of 9 total inhibitory neurons and 39 total excitatory neurons. Each of the output neurons are excitatory. \label{spinnIO}}
\end{figure}
