...
Each letter was represented by a 48-dimensional binary vector of $1s$ or $0s$. Figures 1 and 2 are examples of letters with fairly similar input vectors, for illustration.

\begin{figure}
\centering
\includegraphics[scale=0.3]{imgs/U.png}
\caption{The letter U.}
\includegraphics[scale=0.3]{imgs/V.png}
\caption{The letter V.}
\end{figure}
...
Each coordinate of the 48-dimensional input spikes its cooresponding input neuron. Figure 3 is an example of a letter with its input vector.

\begin{figure}
\centering
\includegraphics[scale=0.3]{imgs/A.png}
\caption{000000001100010010010010011110010010010010010010}
\end{figure}

The letters were randomly generated by a Python script which sends a spike to the SpiNNaker machine serially. Three of the chips were used for input, feeding their spike information to the fourth as an output chip, illustrated in [figure].

\begin{figure}
\centering
\includegraphics[scale=0.3]{imgs/SpiNN4IO.png}
\caption{Illustration of three Input and one Output chips}
\end{figure}
